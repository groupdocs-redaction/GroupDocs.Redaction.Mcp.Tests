...
Per-change notes for the GroupDocs.Redaction.Mcp integration tests repo, captured
...
`package-under-test` field records which `GroupDocs.Redaction.Mcp` version the
