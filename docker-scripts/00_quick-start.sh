...
# Run all tests locally against the LATEST nuget.org release (FASTEST + default)
...
# Use GroupDocs license (removes watermark from output files)
...
for v in 26.4.0 26.5.1 latest; do
