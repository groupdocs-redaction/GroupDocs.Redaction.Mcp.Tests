...
- All redaction tools succeed in evaluation mode — output is just watermarked.
  Set `GROUPDOCS_LICENSE_PATH` to remove watermarks. See each guide's "License"
  section.
- Evaluation-mode output may include a watermark. The server surfaces this in
